...
class HTMLSlideRenderer:
    ...
    def render_slide(self, slide: Slide, slide_index: int = 0) -> str:
    ...
    def render_deck(self, slidespec: SlideSpec) -> str:
        ...
        for idx, slide in enumerate(slidespec.slides):
            slide_html = self.render_slide(slide, idx)
    ...
    def render_slide_dict(self, slide_dict: dict[str, Any], slide_index: int = 0) -> str:
        ...
        return self.render_slide(slide, slide_index)
